...
function MyLists() {
  ...
  return (
    <>
      <div className="w-full min-h-[calc(100vh-14rem)] pb-8 flex flex-col items-center justify-center gap-8">
        {lists.length === 0 && (
        ...
        {/* {lists.length > 0 &&
          lists.map((list) => (
            <SliderList movies={list.movies} category="My List"></SliderList>
          ))} */}
        <button
